...
# Session Settings for Banking Security
# Banking session expires after 30 minutes of inactivity
SESSION_COOKIE_AGE = 60 * 30  # 30 minutes (1800 seconds)
SESSION_SAVE_EVERY_REQUEST = True  # Extend session on each request (activity-based)
