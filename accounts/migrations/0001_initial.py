# Generated by Django 5.2.7 on 2025-10-19 09:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(choices=[('pending', 'Pending Approval'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('frozen', 'Frozen')], default='pending', max_length=20)),
                ('credit_score', models.IntegerField(default=500, help_text='Credit score for pre-approvals')),
                ('terms_accepted_at', models.DateTimeField(blank=True, null=True)),
                ('account_approved_at', models.DateTimeField(blank=True, null=True)),
